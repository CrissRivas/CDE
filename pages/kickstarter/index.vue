    ...
    <v-row justify="center" align="center">
      <v-col sm="6">
        <v-card class="pa-2">
          <v-row>
            <v-col sm="6">
              <tble title="Años" :items="analitycs.years" />
            </v-col>
            <v-col sm="6">
              <BarChart :data="analitycs.years_chart" :height="270" />
            </v-col>
          </v-row>
        </v-card>
      </v-col>
      <v-col sm="6">
        <v-card class="pa-2">
          <v-row>
            <v-col sm="6">
              <tble title="Meses" :items="analitycs.months" />
            </v-col>
            <v-col sm="6">
              <BarChart :data="analitycs.months_chart" :height="270" />
            </v-col>
          </v-row>
        </v-card>
      </v-col>
